...
CURRENT WEEK {week_num} QUICK REFERENCE:
- Check the schedule tables in the PDF for Week {week_num} assignments
- Kitchen trash occurs on Monday, Thursday, Sunday with rotating assignments
- Black trash can goes out every Tuesday night
"""
    return context
...
with st.sidebar:
    ...
    sample_questions = [
        ...
        "Who cleans the bathroom this week?"
    ]
